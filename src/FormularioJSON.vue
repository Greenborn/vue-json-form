...
onMounted(async ()=>{
    ...
    prev_model.value.field_options  = formConfig.value.general_data.field_options
    prev_model.value.initial_values = formConfig.value.general_data.initial_values
})
</script>